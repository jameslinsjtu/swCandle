	...
	#-----------------------------------------------------------
	# Compiling slave.c (/tmp/ccI#.LVVFK5)
	#-----------------------------------------------------------
	...
	.file	1	"/home/export/online1/systest/swsjtu/jxtest/jx/probes/inter-core/test_rlc_noperf_p2p/slave.c"
...
#	.spillsp $15, 0
	ldi	$26,160($sp)              	# [5] anon48
	.loc	1	73	0
	ldi	$23,96($sp)               	# [6] anon45
	.loc	1	85	0
#  81  
...
#	.vframe $15
	...
	.loc	1	45	0
	stw	$21,976($sp)              	# [9] anon18
	.loc	1	79	0
	ldbu	$8,135($sp)              	# [9] anon47+7
	.loc	1	55	0
	mulw	$21,$21,$21              	# [9] 
	.loc	1	48	0
...
#  67  if(id%8==0){
	...
	zapnot	$5,1,$5                	# [24] 
	.loc	1	54	0
	stw	$31,296($sp)              	# [25] mode
	.loc	1	67	0
	ldw	$4,160($sp)               	# [25] anon48
	.loc	1	85	0
	and	$5,$17,$5                 	# [25] 
	.loc	1	60	0
	ldi	$17,160($sp)              	# [25] anon48
	.loc	1	67	0
	and	$4,$19,$4                 	# [28] 
	.loc	1	59	0
	ldi	$19,160($sp)              	# [28] anon48
	.loc	1	49	0
	vstd	$2,448($sp)              	# [29] anon41
	.loc	1	67	0
	or	$4,8,$4                    	# [29] 
	.loc	1	49	0
	vstd	$2,480($sp)              	# [30] anon40
	.loc	1	56	0
	stl	$24,264($sp)              	# [31] reply
	.loc	1	58	0
	ldi	$24,160($sp)              	# [31] anon48
	.loc	1	46	0
	stw	$0,48($sp)                	# [32] anon20
	.loc	1	49	0
	vstd	$2,512($sp)              	# [33] anon39
	.loc	1	58	0
	stw	$31,248($sp)              	# [34] op
	.loc	1	49	0
	vstd	$2,544($sp)              	# [35] anon38
	vstd	$2,576($sp)              	# [36] anon37
	.loc	1	59	0
	stw	$31,232($sp)              	# [37] mode
	.loc	1	51	0
	stw	$31,100($sp)              	# [38] anon46
	.loc	1	49	0
	vstd	$2,608($sp)              	# [39] anon36
	vstd	$2,64($sp)               	# [40] anon26
	.loc	1	51	0
	stw	$31,96($sp)               	# [40] anon45
	.loc	1	49	0
	vstd	$2,640($sp)              	# [41] anon35
	.loc	1	61	0
	stl	$26,208($sp)              	# [42] a
	.loc	1	73	0
	sth	$23,136($sp)              	# [43] anon47+8
	.loc	1	61	0
	ldi	$23,100($sp)              	# [43] anon46
	.loc	1	49	0
	vstd	$2,672($sp)              	# [44] anon34
	.loc	1	61	0
	stl	$23,200($sp)              	# [45] reply
	.loc	1	49	0
	vfmov	$2,$23                  	# [45] 
	.loc	1	55	0
	stw	$21,280($sp)              	# [46] size
	.loc	1	49	0
	vfmov	$2,$21                  	# [46] 
	.loc	1	85	0
	stb	$8,135($sp)               	# [47] anon47+7
	.loc	1	73	0
	sth	$18,168($sp)              	# [47] anon48+8
	.loc	1	49	0
	vfmov	$2,$8                   	# [47] 
	vstd	$2,704($sp)              	# [48] anon33
	vfmov	$2,$18                  	# [48] 
	.loc	1	67	0
	stw	$3,128($sp)               	# [49] anon47
	stw	$4,160($sp)               	# [49] anon48
	.loc	1	85	0
	stb	$5,167($sp)               	# [50] anon48+7
	.loc	1	49	0
	vstd	$2,768($sp)              	# [51] anon31
...
#	.copy_state 1
	...
	vstd	$0,672($sp)              	# [58] anon34
	vldd	$0,704($sp)              	# [58] anon33
	vstd	$23,736($sp)             	# [63] anon32
	vstd	$0,704($sp)              	# [63] anon33
	vldd	$0,768($sp)              	# [64] anon31
	vstd	$8,896($sp)              	# [69] anon27
	vstd	$25,864($sp)             	# [69] anon28
	vstd	$18,832($sp)             	# [70] anon29
	vstd	$21,800($sp)             	# [70] anon30
	vstd	$0,768($sp)              	# [71] anon31
	vldd	$0,928($sp)              	# [71] anon25
	stl	$16,-32($15)              	# [76] para
	fstd	$22,968($sp)             	# [76] anon22
